...
<div class="page-wrapper">
    ...
    <section class="page-title" style="background-image:url(images/background/8_1.jpg);">
        <div class="auto-container">
            <div class="inner-container clearfix">
                <h1>Servicio de Revisión de Frenos</h1>
                <ul class="bread-crumb clearfix">
                    <li><a href="index.php">Inicio</a></li>
                    <li>Servicio de Revisión de Frenos</li>
                </ul>
            </div>
        </div>
    </section>
                    ...
                    <div class="service-detail">
                      ...
                      -->
                        ...
                        <div class="lower-content">
                            <h2>Servicio de Revisión de Frenos</h2>
                            <h3>
                              Pastillas de freno
                            </h3>
                            <p>
                              Las pastillas de freno tienen una duración muy variada, dependiendo del vehículo, del estilo de conducción y del uso. Por ello, pueden durar entre 15.000 km y 80.000 km. Independientemente de si uno conduce sobre todo en ciudad (continuo tráfico de frenar y acelerar) o de si usa el freno del motor.
                            </p>
                            <p>
                              El momento idóneo para cambiar las pastillas depende de cada tipo de conductor. Éstas suelen comprobarse cuando se desmontan las ruedas a la hora de cambiar los neumáticos en nuestro taller, los vehículos más modernos llevan un indicador eléctrico de desgaste que se enciende cuando el material de fricción se encuentra por debajo de un grosor determinado.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <aside class="sidebar services-sidebar">
                        ...
                        <div class="sidebar-widget categories">
                            <ul class="service-cat-list">
                                ...
                                <li><a href="service-detail-2.php">Balanceo</a></li>
                                <li><a href="service-detail-3.php">Suspensión</a></li>
                                <li class="active"><a href="service-detail-4.php">Revisión de Frenos</a></li>
                                <li><a href="service-detail-5.php">Líquido de Frenos</a></li>
                                <li><a href="service-detail-6.php">Limpieza y Ajuste de Frenos</a></li>
                                <li><a href="service-detail-7.php">Mecánica General</a></li>
                                <li><a href="service-detail-8.php">Escaneo</a></li>
