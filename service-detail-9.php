...
<div class="page-wrapper">
    ...
    <section class="page-title" style="background-image:url(images/background/8_1.jpg);">
        <div class="auto-container">
            <div class="inner-container clearfix">
                <h1>Servicio de Lavado de Motor</h1>
                <ul class="bread-crumb clearfix">
                    <li><a href="index.php">Inicio</a></li>
                    <li>Servicio de Lavado de Motor</li>
                </ul>
            </div>
        </div>
    </section>
                    ...
                    <div class="service-detail">
                      ...
                      -->
                        ...
                        <div class="lower-content">
                            <h2>Servicio de Lavado de Motor</h2>
                            <h3>
                              Lavado de motor con vapor seco
                            </h3>
                            <p>
                              En los sistemas antiguos para limpieza de motores que utilizaban una hidrolavadora hacían un trabajo físico de entre 1,000 y 2,000 libras de presión utilizando10 a 20 litros de agua por minuto, ésta presión y la cantidad de agua puede dañar sensores y el desperdicio de agua poco a poco acaba con nuestro planeta.
                            </p>
                            <p>
                              Nuestro sistema ecológico de alta temperatura y bajo consumo de agua ayuda a hacer limpieza de motores eficiente, deshaciendo grasa y eliminando polvo y reduciendo en un 95% el daño a cualquier tipo de sensor.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <aside class="sidebar services-sidebar">
                        ...
                        <div class="sidebar-widget categories">
                            <ul class="service-cat-list">
                                ...
                                <li><a href="service-detail-7.php">Mecánica General</a></li>
                                <li><a href="service-detail-8.php">Escaneo</a></li>
                                <li class="active"><a href="service-detail-9.php">Lavado de Motor</a></li>
                                <li><a href="service-detail-10.php">Venta de Llantas</a></li>
                                <li><a href="service-detail-11.php">Nitrógeno</a></li>
                            </ul>
                        </div>
