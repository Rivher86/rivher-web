...
<div class="page-wrapper">
    ...
    <section class="page-title" style="background-image:url(images/background/8_1.jpg);">
        <div class="auto-container">
            <div class="inner-container clearfix">
                <h1>Sevicios de Alineación</h1>
                <ul class="bread-crumb clearfix">
                    <li><a href="index.php">Inicio</a></li>
                    <li>Servicio de Alineación</li>
                </ul>
            </div>
        </div>
    </section>
                ...
                <div class="content-side pull-right col-lg-9 col-md-8 col-sm-12 col-xs-12">
                    <div class="service-detail">
                        ...
                        <div class="lower-content">
                            ...
                            <p>
                              La alineación del vehículo ajusta los ángulos de las ruedas, manteniéndolas perpendiculares al suelo y paralelas entre sí.
                            </p>
                            <h3>¿Por qué es importante realizar la alineación?</h3>
                            <p>
                            ...
                            <div class="two-column">
                                <div class="row clearfix">
                                    <div class="info-column col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <ul>
                                            <li>El desgaste irregular de los neumáticos, aumentando su vida útil.</li>
                                            <li>El aumento de la fricción del neumático en el suelo, contribuyendo con la economía de combustible del vehículo.</li>
                                            <li>El desplazamiento del vehículo, mejorando la facilidad de conducción y la seguridad.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <aside class="sidebar services-sidebar">
                        ...
                        <div class="sidebar-widget categories">
                            <ul class="service-cat-list">
                                <li class="active"><a href="#">Alineación</a></li>
                                <li><a href="service-detail-2.php">Balanceo</a></li>
                                <li><a href="service-detail-3.php">Suspensión</a></li>
                                <li><a href="service-detail-4.php">Revisión de Frenos</a></li>
                                <li><a href="service-detail-5.php">Líquido de Frenos</a></li>
