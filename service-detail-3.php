...
<div class="page-wrapper">
    ...
    <section class="page-title" style="background-image:url(images/background/8_1.jpg);">
        <div class="auto-container">
            <div class="inner-container clearfix">
                <h1>Sevicios de Balanceo</h1>
                <ul class="bread-crumb clearfix">
                    <li><a href="index.php">Inicio</a></li>
                    <li>Servicios de Suspensión</li>
                </ul>
            </div>
        </div>
    </section>
                    ...
                    <div class="service-detail">
                      ...
                      -->
                        ...
                        <div class="lower-content">
                            <h2>Servicio de Suspensión</h2>
                            <p>
                              La suspensión son un grupo de piezas que se encargan de mantener las llantas pegadas al piso. Con ella se absorben todos los desperfectos que hay en el camino mientras estamos conduciendo. Esta parte del auto recibe el impacto al pasar un bache o un tope evitando que llegue a la cabina. También le da estabilidad al coche.
                            </p>
                            <p>
                            ...
                            <p>
                              Por eso es importante revisar tu suspensión, y realizar las reparaciones en tiempo, para evitar un gasto mayor.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <aside class="sidebar services-sidebar">
                        ...
                        <div class="sidebar-widget categories">
                            <ul class="service-cat-list">
                                <li><a href="service-detail.php">Alineación</a></li>
                                <li><a href="service-detail-2.php">Balanceo</a></li>
                                <li class="active"><a href="service-detail-3.php">Suspensión</a></li>
                                <li><a href="service-detail-4.php">Revisión de Frenos</a></li>
                                <li><a href="service-detail-5.php">Líquido de Frenos</a></li>
                                <li><a href="service-detail-6.php">Limpieza y Ajuste de Frenos</a></li>
                                <li><a href="service-detail-7.php">Mecánica General</a></li>
