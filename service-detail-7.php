...
<div class="page-wrapper">
    ...
    <section class="page-title" style="background-image:url(images/background/8_1.jpg);">
        <div class="auto-container">
            <div class="inner-container clearfix">
                <h1>Servicio de Mecánica General</h1>
                <ul class="bread-crumb clearfix">
                    <li><a href="index.php">Inicio</a></li>
                    <li>Servicio de Mecánica General</li>
                </ul>
            </div>
        </div>
    </section>
                    ...
                    <div class="service-detail">
                      ...
                      -->
                        ...
                        <div class="lower-content">
                            <h2>Servicio de Mecánica General</h2>
                            <p>
                              En RIVHER atendemos problemas de mecánica general en la cual atendemos afinaciones mayores, fallas de motor, fallas eléctricas, revisión del sistema por computadora, remplazo de juntas, bandas y sensores. Etc. Buscando la solución del problema al mejor costo.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <aside class="sidebar services-sidebar">
                        ...
                        <div class="sidebar-widget categories">
                            <ul class="service-cat-list">
                                ...
                                <li><a href="service-detail-5.php">Líquido de Frenos</a></li>
                                <li><a href="service-detail-6.php">Limpieza y Ajuste de Frenos</a></li>
                                <li class="active"><a href="service-detail-7.php">Mecánica General</a></li>
                                <li><a href="service-detail-8.php">Escaneo</a></li>
                                <li><a href="service-detail-9.php">Lavado de Motor</a></li>
                                <li><a href="service-detail-10.php">Venta de Llantas</a></li>
                                <li><a href="service-detail-11.php">Nitrógeno</a></li>
