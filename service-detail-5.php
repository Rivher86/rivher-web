...
<div class="page-wrapper">
    ...
    <section class="page-title" style="background-image:url(images/background/8_1.jpg);">
        <div class="auto-container">
            <div class="inner-container clearfix">
                <h1>Servicio de Líquido de Frenos</h1>
                <ul class="bread-crumb clearfix">
                    <li><a href="index.php">Inicio</a></li>
                    <li>Servicio de Líquido de Frenos</li>
                </ul>
            </div>
        </div>
    </section>
                    ...
                    <div class="service-detail">
                      ...
                      -->
                        ...
                        <div class="lower-content">
                            <h2>Servicio de Líquido de Frenos</h2>

                            <p>
                              La principal función del líquido de frenos es transmitir la fuerza ejercida sobre el pedal de freno a las pastillas y/o zapatas para llegar a detener el vehículo siendo un elemento clave en la seguridad del vehículo y de los ocupantes.
                            </p>
                    ...
                    <aside class="sidebar services-sidebar">
                        ...
                        <div class="sidebar-widget categories">
                            <ul class="service-cat-list">
                                ...
                                <li><a href="service-detail-3.php">Suspensión</a></li>
                                <li><a href="service-detail-4.php">Revisión de Frenos</a></li>
                                <li class="active"><a href="service-detail-5.php">Líquido de Frenos</a></li>
                                <li><a href="service-detail-6.php">Limpieza y Ajuste de Frenos</a></li>
                                <li><a href="service-detail-7.php">Mecánica General</a></li>
                                <li><a href="service-detail-8.php">Escaneo</a></li>
                                <li><a href="service-detail-9.php">Lavado de Motor</a></li>
