...
<div class="page-wrapper">
    ...
    <section class="page-title" style="background-image:url(images/background/8_1.jpg);">
        <div class="auto-container">
            <div class="inner-container clearfix">
                <h1>Servicio de Venta de Llantas</h1>
                <ul class="bread-crumb clearfix">
                    <li><a href="index.php">Inicio</a></li>
                    <li>Servicio de Venta de Llantas</li>
                </ul>
            </div>
        </div>
    </section>
                    ...
                    <div class="service-detail">
                      ...
                      -->
                        ...
                        <div class="lower-content">
                            <h2>Servicio de Venta de Llantas</h2>
                            <p>
                              En rivher buscamos brindarte una asesoría en la adquisición de tus neumáticos, por ello contamos con marcas que buscan satisfacer tus necesidades como son: PIRELLI, MICHELIN, GOODYEAR, BRIGESTONE, CONTINENTAL, DUNLOP, KUMHO, TOYO TIRES, SUMITOMO, HANKOOK entre muchas marcas más. Tanto auto, camioneta, carga y agrícola.
                            </p>
                    ...
                    <aside class="sidebar services-sidebar">
                        ...
                        <div class="sidebar-widget categories">
                            <ul class="service-cat-list">
                                ...
                                <li><a href="service-detail-8.php">Escaneo</a></li>
                                <li><a href="service-detail-9.php">Lavado de Motor</a></li>
                                <li class="active"><a href="service-detail-10.php">Venta de Llantas</a></li>
                                <li><a href="service-detail-11.php">Nitrógeno</a></li>
                            </ul>
                        </div>
                    </aside>
