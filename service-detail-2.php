                    ...
                    <div class="service-detail">
                      ...
                      -->
                        ...
                        <div class="lower-content">
                            <h2>Servicio de Balanceo</h2>
                            <p>
                              El balanceo de un neumático permite que la rueda gire sin provocar vibraciones en los vehículos a determinadas velocidades.
                            </p>
                            <h3>¿Por qué es importante realizar el Balanceo?</h3>
                            <p>
                              Las consecuencias de no realizar el balanceo o de un procedimiento mal realizado en las ruedas delanteras y traseras se materializan en vibraciones, ya sea en el volante, en el piso del auto, en el tablero de instrumentos o en los asientos, en distintas franjas de velocidades.
                            </p>
                            <p>
                              El balanceo en las cuatro ruedas es fundamental para el confort en la conducción y el mantenimiento del desempeño de los neumáticos.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <aside class="sidebar services-sidebar">
                        ...
                        <div class="sidebar-widget categories">
                            <ul class="service-cat-list">
                                <li><a href="service-detail.php">Alineación</a></li>
                                <li class="active"><a href="service-detail-2.php">Balanceo</a></li>
                                <li><a href="service-detail-3.php">Suspensión</a></li>
                                <li><a href="service-detail-4.php">Revisión de Frenos</a></li>
                                <li><a href="service-detail-5.php">Líquido de Frenos</a></li>
                                <li><a href="service-detail-6.php">Limpieza y Ajuste de Frenos</a></li>
